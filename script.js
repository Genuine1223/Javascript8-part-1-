...
function greetUser(){
    ...
    document.getElementById("geeting").textContent = message;
}
...
function checkLogin() {
    const loginInput =
    document.getElementById("loginInput").value.toLowerCase();
    const isLoggIn = loginInput === "yes";
